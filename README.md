...
int main() {
    ...
    printf("Plain text : ");
    fgets(text, sizeof(text), stdin);  // Read the input string
...
![Screenshot 2024-09-02 122505](https://github.com/user-attachments/assets/8f561bd3-62b5-49d5-bafb-0f06a0a053ba)
...
![Screenshot 2024-09-02 122849](https://github.com/user-attachments/assets/531a118f-40db-47f3-b390-afc5666079e4)
...
![Screenshot 2024-09-02 123029](https://github.com/user-attachments/assets/c7f294ff-46fe-49bb-8336-86ccf8ceae22)
...
![Screenshot 2024-09-02 123244](https://github.com/user-attachments/assets/c9f1f52e-9401-4e68-8477-ac6769005db7)
...
void encryptRailFence(char *text, int key, char *cipherText) {
    int len = strlen(text);
    int row, col;
    int direction = -1; // used to change direction (up/down) of rail
    int rail[key][len];
    ...
    for (col = 0; col < len; col++) {
        // Place the characters in the rail matrix
        rail[row][col] = text[col];

        // Change direction when the top or bottom is reached
        if (row == 0 || row == key - 1) {
            direction *= -1;
        }
    ...
    // Read the rail matrix row by row to generate the cipher text
    int k = 0;
    ...
    cipherText[k] = '\0'; // Null-terminate the cipher text
}
...
void decryptRailFence(char *cipherText, int key, char *plainText) {
    ...
    // Read the rail matrix in a zig-zag manner to get the plain text
    row = 0;
    direction = -1;
    for (col = 0; col < len; col++) {
    ...
    plainText[len] = '\0'; // Null-terminate the plain text
}
...
![Screenshot 2024-09-02 123413](https://github.com/user-attachments/assets/095d089f-b61e-44d2-a1d0-f9b444dbcca6)
